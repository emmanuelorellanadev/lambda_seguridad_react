            ...
            <div className='h3'>
                ...
                <form id='miFormulario' onSubmit={ botonGuardar }>
                    <div className='row' style={{ marginTop: 20}}>
                        <div className='col-6'>
                            <input className='form-control form-control-lg text-center' type="text" placeholder='Digite El Titulo' onChange={ (e) => setTitulo(e.target.value)} required  />
                        </div>
                        <div className='col-6'>
                    ...
                    <div className='row' style={{ marginTop: 20}}>
                        <div className='col-6'>
                            <select className='form-select form-select-lg text-center' onChange={ (e) => setTecnica(e.target.value)} required>
                                <option value="">Indique Tecicas</option>
